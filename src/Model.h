...
public:
  ...
  GLuint MaxNumTexture(){
    GLuint maxNum = 0;
    GLuint temp;
    for(GLuint i = 0; i < this->meshes.size(); i++){
      temp = this->meshes[i].textures.size();
...
private:
   ...
   Mesh processMesh(aiMesh* mesh, const aiScene* scene)
   {
       ...
       if(mesh->mMaterialIndex >= 0)
       {
           ...
           // 2. Depth maps, I use ambient texture channel here since I don't find the height texture alias in mtl file.
